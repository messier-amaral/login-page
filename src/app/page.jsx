...
export default function Home() {
  ...
  return (
    <main className="h-screen flex flex-col justify-center items-end bg-alice-blue bg-wallpaper-login-desktop bg-no-repeat bg-left bg-cover bg-contain">
      ...
      <div className='flex flex-col justify-center w-[400px] mr-40 items-center'>
        ...
        <Link href='#' className='mt-[8px] font-emphasis text-pigment-green hover:underline'>Don&apos;t have account? Sign up</Link>
      </div>
    </main>
  )
}
